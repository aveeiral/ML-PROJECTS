...
movieLabel = tk.Label(root, text="Enter Movie Name : ", bg="skyblue")
movieLabel.grid(row=1, column=0, padx=10, pady=5)
movieEntry = tk.Entry(root, width=36)
movieEntry.grid(row=1, column=1, padx=10, pady=5)

findButton = tk.Button(root, text="Find Similar Movies", command=m_recommendation)
findButton.grid(row=2, column=0, padx=10, pady=5)#, columnspan = 2)


res_Label = tk.Label(root, width=35, height=40, padx=10, pady=2, bg="skyblue")
res_Label.grid(row=2, column=2)
